...
public interface HTTPUtilities
{
     ...
     */
    @Deprecated
    String setRememberToken(String password, int maxAge, @RUntainted String domain, String path);

    /**
     *
     */
    String setRememberToken(HttpServletRequest request, HttpServletResponse response, int maxAge, @RUntainted String domain, String path);
